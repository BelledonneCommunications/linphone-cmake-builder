	...
	if(WIN32)
		...
		if(APPLE)
			if(IOS)
				...
				lcb_extra_cflags("--target=${CMAKE_C_COMPILER_TARGET} ${FLAGS}")
				lcb_extra_cppflags("--target=${CMAKE_C_COMPILER_TARGET} ${FLAGS}")
				lcb_extra_cxxflags("--target=${CMAKE_C_COMPILER_TARGET} ${FLAGS}")
				lcb_extra_ldflags("--target=${CMAKE_C_COMPILER_TARGET} ${FLAGS}")
