...
set(EP_ms2_CMAKE_OPTIONS
	...
	"-DENABLE_SCREENSHARING=${ENABLE_SCREENSHARING}"
)
...
if(ENABLE_SCREENSHARING)
	list(APPEND EP_ms2_DEPENDENCIES EP_freerdp)
endif()
list(APPEND EP_ms2_CMAKE_OPTIONS "-DENABLE_G729B_CNG=${ENABLE_G729B_CNG}")
if(ENABLE_G729B_CNG AND LINPHONE_BUILDER_BUILD_DEPENDENCIES )
	list(APPEND EP_bcg729_CMAKE_OPTIONS "-DENABLE_MSPLUGIN=NO")
	list(APPEND EP_ms2_DEPENDENCIES EP_bcg729)
endif()
