############################################################################
# Copyright (c) 2014-2022 Belledonne Communications SARL.
#
...
if(WIN32)
	if(MSVC)
		if( CMAKE_SIZEOF_VOID_P EQUAL 8 )
			lcb_additional_options("OS=\"msvc\" ARCH=\"x86_64\"")
		else()
			lcb_additional_options("OS=\"msvc\" ARCH=\"i386\"")
		endif()
	endif()
elseif(ANDROID)
...
elseif(APPLE)
	if(IOS)
		if(CMAKE_SYSTEM_PROCESSOR STREQUAL "aarch64")
			set(ADDITIONAL_OPTIONS "OS=\"ios\" ARCH=\"arm64\"")
			#XCode7  allows bitcode
			if (NOT ${XCODE_VERSION} VERSION_LESS 7)
				lcb_extra_cflags("-fembed-bitcode")
			endif()
		elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL "armv7")
			set(ADDITIONAL_OPTIONS "OS=\"ios\" ARCH=\"armv7\"")
			#XCode7  allows bitcode
			if (NOT ${XCODE_VERSION} VERSION_LESS 7)
				lcb_extra_cflags("-fembed-bitcode")
			endif()
		elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64")
			set(ADDITIONAL_OPTIONS "OS=\"ios\" ARCH=\"x86_64\"")
		else()
			set(ADDITIONAL_OPTIONS "OS=\"ios\" ARCH=\"i386\"")
		endif()
		if (PLATFORM STREQUAL "Simulator")
			set(ADDITIONAL_OPTIONS "${ADDITIONAL_OPTIONS} SDKTYPE=\"iPhoneSimulator\"")
		else()
			set(ADDITIONAL_OPTIONS "${ADDITIONAL_OPTIONS} SDKTYPE=\"iPhoneOS\"")
		endif()
		lcb_additional_options("${ADDITIONAL_OPTIONS}")
	else()
		...
		lcb_extra_cflags("${FLAGS}")
		lcb_extra_cxxflags("${FLAGS}")
		lcb_extra_cppflags("${FLAGS}")
