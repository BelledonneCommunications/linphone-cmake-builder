...
if(CMAKE_SYSTEM_NAME STREQUAL "WindowsStore")
	...
	elseif(APPLE)
		if(IOS)
			...
			set(MAC_ARCH "--target=${CMAKE_SYSTEM_PROCESSOR}-apple-darwin")
			...
			lcb_extra_cppflags("${MAC_ARCH} -isysroot ${CMAKE_OSX_SYSROOT} -mmacosx-version-min=${CMAKE_OSX_DEPLOYMENT_TARGET}")
