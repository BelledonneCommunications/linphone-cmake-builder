...
export CPPFLAGS="@LINPHONE_BUILDER_CPPFLAGS@ @EP_openh264_EXTRA_CPPFLAGS@"
export CFLAGS="@LINPHONE_BUILDER_CFLAGS@ @EP_openh264_EXTRA_CFLAGS@" 
export CXXFLAGS="@LINPHONE_BUILDER_CXXFLAGS@ @EP_openh264_EXTRA_CXXFLAGS@"
export OBJCFLAGS="@LINPHONE_BUILDER_OBJCFLAGS@"
export LDFLAGS="@LINPHONE_BUILDER_LDFLAGS@ @EP_openh264_EXTRA_LDFLAGS@"
...
cd @ep_build@
make -f @ep_source_relative_to_build@/Makefile install@EP_openh264_LINKING_TYPE@ DESTDIR="@CMAKE_INSTALL_PREFIX@" PREFIX="" BUILDTYPE="@OPENH264_BUILD_TYPE@" @EP_openh264_ADDITIONAL_OPTIONS@ @ep_redirect_to_file@
