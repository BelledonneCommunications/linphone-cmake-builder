	...
	elseif(APPLE)
		if(IOS)
			...
			elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL "arm64")
				set(VPX_TARGET "arm64-darwin10-gcc")
				lcb_extra_cflags("-arch arm64 -isysroot ${CMAKE_OSX_SYSROOT} -mmacosx-version-min=${CMAKE_OSX_DEPLOYMENT_TARGET}")
				lcb_extra_cxxflags("-arch arm64 -isysroot ${CMAKE_OSX_SYSROOT} -mmacosx-version-min=${CMAKE_OSX_DEPLOYMENT_TARGET}")
				lcb_extra_cppflags("-arch arm64 -isysroot ${CMAKE_OSX_SYSROOT} -mmacosx-version-min=${CMAKE_OSX_DEPLOYMENT_TARGET}")
				lcb_extra_ldflags("-arch arm64")
			else()
