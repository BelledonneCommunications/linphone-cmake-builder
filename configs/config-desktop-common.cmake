...
if(APPLE)
	...
	if(CMAKE_SIZEOF_VOID_P EQUAL 8)
		...
		string(FIND "${CMAKE_SYSTEM_PROCESSOR}" "arm" arm_found)
		if (arm_found EQUAL -1)
			set(LINPHONE_BUILDER_HOST "${CMAKE_SYSTEM_PROCESSOR}-apple-darwin")
		else()
			set(LINPHONE_BUILDER_HOST "aarch64-apple-darwin")
		endif()
	else()
...
if(WIN32)
	...
	if(ENABLE_MICROSOFT_STORE_APP AND NOT(CMAKE_BUILD_TYPE STREQUAL "Debug") )
		lcb_builder_extra_ldflags(linphone "/SAFESEH")
	else()
...
if(WIN32)
	...
	if(ENABLE_MICROSOFT_STORE_APP AND NOT(CMAKE_BUILD_TYPE STREQUAL "Debug") )
		lcb_builder_extra_ldflags(ms2 "/SAFESEH")
	else()
